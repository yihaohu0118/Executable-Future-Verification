...
- The max-absolute-action heuristic is a strong baseline on the n16 ordinary no-demo pool. Energy-matched candidates beat that shortcut, action-only selectors still leave a large oracle gap, and n8 state traces close most of it at 30.4/32 even under regenerated random-position placement; future results need visual/contact conditioning, not just more action summaries.
