...
4. Replace the manifest-level rank/candidate-id randomization control with a fully regenerated rollout pool using randomized original-candidate placement.
