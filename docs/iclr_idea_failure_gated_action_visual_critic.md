...
4. Convert the EEF/gripper execution-envelope result into a deployable visual/contact/tactile-conditioned selector: the target is to preserve the 63-64/64 proxy gain without simulator-state access.
