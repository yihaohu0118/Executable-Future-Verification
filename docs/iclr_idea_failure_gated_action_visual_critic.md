...
4. Convert the EEF/gripper execution-trace result into a deployable visual/contact/tactile-conditioned selector: the target is to preserve the 62-64/64 proxy gain without simulator-state access.
