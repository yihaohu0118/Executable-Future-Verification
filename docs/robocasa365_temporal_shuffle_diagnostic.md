...
| Target-task calibration cases | Seeds | Overall success | Mean | Std |
| ---: | --- | ---: | ---: | ---: |
| 0, leave-one-task-out | 0,1,2,3,4 | 31,20,27,26,24 | 25.6 | 3.61 |
| 1 | 0,1,2,3,4 | 27,26,19,25,24 | 24.2 | 2.79 |
| 2 | 0,1,2,3,4 | 43,50,50,44,47 | 46.8 | 2.93 |
| 4 | 0,1,2,3,4 | 57,55,58,60,54 | 56.8 | 2.14 |
| 8 | 0,1,2,3,4 | 62,62,59,61,61 | 61.0 | 1.10 |
| all available same-task cases | 0,1,2,3,4 | 62,64,62,62,62 | 62.4 | 0.80 |

For balanced shared-onehot EEF+gripper distribution selectors, where every task is capped to K training cases in each held-out fold:

| Per-task calibration cases | Seeds | Overall success | Mean | Std |
| ---: | --- | ---: | ---: | ---: |
| 1 | 0,1,2,3,4 | 43,39,40,40,44 | 41.2 | 1.94 |
| 2 | 0,1,2,3,4 | 47,48,52,53,45 | 49.0 | 3.03 |
...
| ---: | --- | --- | ---: | ---: | ---: |
| 0 | shared, no task ID | 0,1,2,3,4 | 26,24,26,26,26 | 25.6 | 0.80 |
| 1 | shared, no task ID | 0,1,2,3,4 | 42,42,44,40,43 | 42.2 | 1.33 |
| 2 | shared, no task ID | 0,1,2,3,4 | 53,53,52,50,54 | 52.4 | 1.36 |
| 4 | shared, no task ID | 0,1,2,3,4 | 59,54,56,55,57 | 56.2 | 1.72 |
| 8 | shared, no task ID | 0,1,2,3,4 | 60,61,60,61,60 | 60.4 | 0.49 |
